...
const LandingPage = () => {
  let slidesInfo = [
    ...
    {
      text: 'היחידה אחראית על תגובה מיידית באירועי קיצון ומשתלבת בכוחות המיוחדים של חה"א לצד שלדג ו-669. פעילות חשאית מול התראות וכוח התערבות בעת אירועי קיצון וטרור',
      page: "2/8",
      className: "slide"
    ...
    {
      text: "רכישת מיומנויות ייחודיות במהלך המסלול בעולמות תוכן ייחודיים - צליפה, רחפנים, רפואה, לוחמה בשטח בנוי, מארבים, מרדפים עם מסוקים, איסוף מודיעין מהקרקע ומהאוויר",
      page: "5/8",
      className: "slide"
